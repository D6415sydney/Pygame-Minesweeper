...
adjacent = [img0, img1, img2, img3, img4, img5, img6, img7, img8]
...
# Placing mines
def place_mines(num, fx, fy, rows, cols):
    mines = []
    pos = [fx, fy]
    for i in range(num):
...
def init_game(width, height):
    ...
    # mines = place_mines(1, 1, 1, width, height) # The first 3 values are temporary
